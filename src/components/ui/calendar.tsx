...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'group/calendar [--cell-size:2rem] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent',
      ...
      classNames={{
        ...
        dropdown_root: cn(
          'relative has-focus:border-ring border border-input shadow-2xs has-focus:ring-ring/50 has-focus:ring-[3px] rounded-md hidden',
        ...
        today: cn(
          'bg-primary/25 text-primary-foreground rounded-md data-[selected=true]:rounded-none',
        ...
        Dropdown: ({ value, onChange, className, ...props }: any) => {
          ...
          return (
            <Select value={value?.toString()} onValueChange={handleChange}>
              <SelectTrigger
                className={cn(
                  'h-8 w-fit border-none shadow-none focus:ring-0 bg-transparent',
                  className
                )}>
                <SelectValue />
              </SelectTrigger>
